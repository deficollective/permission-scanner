...
interface IMaverickV2IncentiveMatcherFactory {
    ...
    /**
     * @notice This function retrieves the address of the
     * MaverickV2IncentiveMatcherCaller which is permissioned to make
     * addIncentive calls to IncentiveMatcher contracts.
     */
